    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="{{ route('instructor.course.store') }}" class="row g-3" method="post"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select mb-3" name="subcategory_id" aria-label="subcategory_id">
                            <option value="{{ old('subcategory_id') }}"></option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 mb-2">
                        ...
                        <input type="text" name="resources" value="{{ old('resources') }}"
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" name="bestseller" class="form-check-input" id="bestseller"
                               value="1" {{ old('bestseller') == 1 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" name="highestrated" class="form-check-input" id="highestrated"
                               value="1" {{ old('highestrated') == 1 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="prerequisites" class="@error('prerequisites') is-invalid @enderror form-control"
                                  ...
                                  placeholder="Course Prerequisites...">{{old('prerequisites')}}</textarea>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" class="@error('description') is-invalid @enderror form-control"
                                  id="myeditorinstance">{{ old('description') }}</textarea>
