    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="{{ route('instructor.course.update', $course->id) }}" class="row g-3" method="post"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="@error('image') is-invalid @enderror form-control" name="image" type="file"
                               id="image">
                        @error('image') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>

                    <div class="col-md-6">
                        <img id="showImage" src="{{ url($course->image)}}" alt="Admin"
                             class="rounded p-1 bg-primary" width="120">
                    </div>

                    <div class="col-md-6">
                        <label for="video" class="form-label">Course intro Video</label>
                        <input class="@error('video') is-invalid @enderror form-control" name="video" type="file"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select mb-3" name="subcategory_id" aria-label="subcategory">
                            <option selected="" disabled>Open this select menu</option>
                            @foreach($subCategories as $subcat)
                                <option
                                    value="{{ $subcat->id }}" {{ $subcat->id == $course->subcategory_id ? ' selected' : '' }}
                                >{{ $subcat->title }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select mb-3 @error('certificate') is-invalid @enderror" name="certificate"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select mb-3 @error('label') is-invalid @enderror" name="label"
                                aria-label="label">
                            <option selected="" disabled>Open this select menu</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="selling_price" value="{{ $course->selling_price }}"
                               class="@error('selling_price') is-invalid @enderror form-control" id="selling_price">
                        @error('selling_price') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>

                    <div class="col-md-3">
                        <label for="discount_price" class="form-label">Discount Price</label>
                        <input type="text" name="discount_price" value="{{ $course->discount_price }}"
                               class="@error('discount_price') is-invalid @enderror form-control" id="discount_price">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="duration" value="{{ $course->duration }}"
                               class="@error('duration') is-invalid @enderror form-control" id="duration">
                        @error('duration') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>

                    <div class="col-md-3 mb-2">
                        <label for="resources" class="form-label">Resources</label>
                        <input type="text" name="resources" value="{{ $course->resources }}"
                               class="@error('resources') is-invalid @enderror form-control" id="resources">
                        @error('resources') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>

                    <hr>
                    <div class="col-md-4">
                        <input type="checkbox" name="bestseller" class="form-check-input" id="bestseller"
                               value="1" {{ $course->bestseller == 1 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" name="highestrated" class="form-check-input" id="highestrated"
                               value="1" {{ $course->highestrated == 1 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="prerequisites" class="@error('prerequisites') is-invalid @enderror form-control"
                                  id="prerequisites" rows="3"
                                  placeholder="Course Prerequisites...">{{ $course->prerequisites }}</textarea>
                        @error('prerequisites') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>

                    <div class="col-md-12">
                        <label for="description" class="form-label">Course Description</label>
                        <textarea name="description" class="@error('description') is-invalid @enderror form-control"
