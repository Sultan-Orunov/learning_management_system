                            ...
                            <form class="pt-4" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('email') is-invalid @enderror form-control form--control" type="email" value="{{ old('email') }}" name="email" placeholder="Email...">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="@error('password') is-invalid @enderror form-control form--control password-field" type="password" name="password" placeholder="Password">
