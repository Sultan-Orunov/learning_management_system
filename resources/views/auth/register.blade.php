...
================================= -->
    <section style="height: 18rem" class="breadcrumb-area section-padding img-bg-2">
                            ...
                            <form method="POST" class="pt-4" action="{{ route('register') }}">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('name') is-invalid @enderror form-control form--control" id="name" type="text" name="name" placeholder="First name">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('email') is-invalid @enderror form-control form--control" id="email" type="email" name="email" placeholder="email">
                                        <span class="la la-user input-icon"></span>
                                    </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('password') is-invalid @enderror form-control form--control" id="password" type="password" name="password" placeholder="Username">
                                        <span class="la la-user input-icon"></span>
                                    </div>
