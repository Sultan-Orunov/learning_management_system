        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" class="row" action="{{ route('instructor.store') }}">
                            @csrf
                            <div class="input-box col-lg-6">
                                <label class="label-text">Name</label>
                                <div class="form-group">
                                    <input class="@error('name') is-invalid @enderror form-control form--control" type="text" value="{{ old('name') }}" name="name" placeholder="Name...">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="@error('username') is-invalid @enderror form-control form--control" type="text" value="{{ old('username') }}" name="username" placeholder="User Name...">
                                    <span class="la la-user input-icon"></span>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="@error('email') is-invalid @enderror form-control form--control" type="email" value="{{ old('email') }}" name="email" placeholder="example@email.com">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="@error('phone') is-invalid @enderror form-control form--control" type="text" value="{{ old('phone') }}" name="phone" placeholder="+998001112233">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="@error('address') is-invalid @enderror form-control form--control" type="text" value="{{ old('address') }}" name="address" placeholder="12345 Little Baker St, Melbourne">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="@error('password') is-invalid @enderror form-control form--control" type="password" value="{{ old('password') }}" name="password" placeholder="111111111">
